...
class Dwin_Lcd{
  uint8_t send_buf[11 + DWIN_WIDTH / 6 * 2] = { 0xAA };
  ...
  public:
    ...
    void add_string(char * const string);
    void send(void);
    void set_display_rot(uint8_t);
    void update_lcd(void);
    void add_icon(uint8_t, uint8_t, uint16_t, uint16_t);
    void add_rect(uint8_t, uint16_t, uint16_t, uint16_t, uint16_t, uint16_t);
    void draw_string(bool widthAdjust, bool bShow, uint8_t size,
                      uint16_t color, uint16_t bColor, uint16_t x, uint16_t y, char *string);
    void draw_int(uint8_t bShow, bool zeroFill, uint8_t zeroMode, uint8_t size, uint16_t color,
                          uint16_t bColor, uint8_t iNum, uint16_t x, uint16_t y, uint16_t value);
    void update_status(void);
    void hmi_init(void);
    void draw_status_frame(void);
    void draw_main_frame(void);
    void draw_print_icon(void);
